...
class OpHibernia {
	...
	function GetDate()          { return "2012-08-13"; }
...
//		Manager_Ships = ManShips();
 ...
 function OpHibernia::Run() {
	...
	Log.Note("OpHibernia (GS) running at tick " + tick + ".",1);
	...
	MyIndustries.push(table.oilrig1);
	MyIndustries.push(table.oilrig2);
